...
* Calendar sync (unused)
#+begin_src emacs-lisp :tangle yes
(use-package! org-caldav
  :ensure t
  :config
  (setq org-caldav-url "https://caldav.fastmail.com/dav/calendars/user/romeo@romeov.me")
  (setq org-caldav-calendars
        '((:calendar-id "8EA9017E-0626-11ED-B063-DC7178119CC6"
           :inbox "~/org/calendar.romeov.me.org")))
...
(use-package org-ai
  ...
  :custom
  (org-ai-openai-api-token "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")
  :init
